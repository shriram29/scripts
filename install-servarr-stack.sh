...
TEMPDIR="/tmp/servarr"
APPLIST="jackett sonarr lidarr radarr readarr whisparr prowlarr bazarr"
...
script_info() {
    banner_info
    printf '%s\n' "
    Description:    Installer for Jackett, Sonarr, Radarr, Lidarr, Readarr, Prowler, Whisparr and *Bazarr
...
default_ports() {
    ...
    task_info "Whisparr:   http://hostip:6969"
...
display_menu () {
    ...
    echo "=============="
    echo
    printf "1.  Install ALL (jackett sonarr lidarr radarr readarr whisparr prowlarr bazarr)\n"
    ...
    printf "21.  Install whisparr only\n"
    printf "7.  Install prowlarr only\n"
    printf "8.  Install bazarr only\n"
    printf "\n9.  Remove ALL (jackett sonarr lidarr radarr readarr whisparr prowlarr bazarr)\n"
    ...
    printf "22. Remove whisparr only\n"
    ...
    read choice
    case ${choice} in
        1)  setup_app jackett sonarr lidarr radarr readarr whisparr prowlarr bazarr
            ;;
        2)  setup_app jackett
            ;;
        3)  setup_app sonarr
        ...
        8)  setup_app bazarr
            ;;
        9)  remove_app jackett sonarr lidarr radarr readarr whisparr prowlarr bazarr
            ;;
        ...
        20) printf "\nExiting...\n"
            exit
            ;;
        21)  setup_app whisparr
            ;;
        22) remove_app whisparr
            ;;
        *)  clear
            display_menu
            ;;
